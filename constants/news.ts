...
export const news: NewsItem[] = [
  {
    id: "1",
    title: "BSMU Welcomes New International Students",
    slug: "bsmu-welcomes-new-international-students",
    category: "university",
    date: "2024-12-15",
    excerpt:
    ...
    content: `
      <p>Balkan Science and Management University (BSMU) is thrilled to announce the arrival of over 150 new international students from 30 different countries, marking one of the most diverse cohorts in our university's history.</p>
      ...
      <p>We're excited to see the contributions these new students will make to our university community and wish them success in their academic journey at BSMU.</p>
    `,
    author: "Admissions Office",
    featured: true,
    readTime: 3,
    tags: ["International Students", "Admissions", "University"],
    image: "/images/bsmu-hero-campus.jpg",
  },
  {
    id: "2",
    title: "Annual Science and Management Education Conference 2024",
    slug: "annual-science-and-management-education-conference-2024",
    category: "events",
    date: "2024-12-10",
    excerpt:
      "Join us for our annual Science and Management Education Conference featuring renowned speakers and workshops on global science and management initiatives.",
    content: `
      <p>We're excited to announce the Annual Science and Management Education Conference 2024, scheduled for March 15-17, 2025. This year's conference will focus on "Building Bridges: Education for Global Science and Management."</p>
      
      <h2>Featured Speakers</h2>
      <p>The conference will feature distinguished speakers from around the world, including Nobel Science and Management Prize laureates, renowned academics, and science and management activists.</p>
      
      <h2>Workshops and Sessions</h2>
      <p>Participants can attend various workshops covering topics such as conflict resolution, international diplomacy, and community science and management building.</p>
    `,
    author: "Events Committee",
    featured: true,
    readTime: 5,
    tags: ["Conference", "Science and Management Education", "Events"],
    image: "/images/bsmu-hero-campus.jpg",
  },
  {
    id: "3",
    ...
    date: "2024-12-05",
    excerpt:
      "BSMU celebrates the opening of a state-of-the-art research laboratory dedicated to science and management studies.",
    content: `
      <p>Today marks a significant milestone as we officially open our new research laboratory, equipped with cutting-edge technology for science and management studies and international relations research.</p>
  ...
  },
  {
    ...
    date: "2024-11-25",
    excerpt:
      "BSMU signs partnership agreements with leading Serbian universities to enhance student exchange programs.",
    content: `
  ...
  },
  {
    ...
    date: "2024-11-20",
    excerpt:
      "BSMU launches a new online learning platform providing enhanced digital learning experiences for students.",
    content: `
  ...
  {
    id: "9",
    title: "Sustainability Initiatives at BSMU",
    slug: "sustainability-initiatives-at-bsmu",
    category: "university",
    date: "2024-11-10",
    excerpt:
      "BSMU announces new sustainability initiatives as part of our commitment to environmental responsibility.",
    content: `
  ...
  {
    id: "11",
    title: "New Faculty Members Join BSMU",
    slug: "new-faculty-members-join-bsmu",
    category: "academic",
    date: "2024-10-30",
    excerpt:
      "We welcome distinguished faculty members who bring expertise and innovation to our academic programs.",
    content: `
      <p>We're pleased to welcome several distinguished faculty members to BSMU, bringing valuable expertise and fresh perspectives to our academic programs.</p>
